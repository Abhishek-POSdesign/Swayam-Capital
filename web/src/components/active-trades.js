    ...
    this.container.innerHTML = `
      ...
      <div id="close-modal" class="modal-overlay" style="display: none;">
        <div class="modal-content" style="max-width: 520px;">
          <h3 style="margin-bottom: 0.75rem; color: var(--accent-blue);">Close Position</h3>
    ...
    const rows = this.positions.map((p, idx) => {
      ...
      return `
        <tr data-pos-id="${p.position_id}">
          ...
          <td>
            <a href="${obsidianLink}" style="color: var(--accent-blue); text-decoration: none; font-size: 0.8rem;" title="Open note in Obsidian">
              ${journalFilename} ↗
            </a>
          </td>
