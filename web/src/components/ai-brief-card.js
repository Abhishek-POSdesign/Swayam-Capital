...
export class AIBriefCardComponent {
  ...
  render(briefData = null, errorMessage = null) {
    ...
    this.container.innerHTML = `
      <div class="tile ai-brief-tile span-12" style="border-left: 3px solid var(--accent-blue); background: var(--dl-card); display: flex; flex-direction: column; gap: 10px; padding: 18px 22px;">
        <div style="display: flex; justify-content: space-between; align-items: center;">
          <div style="display: flex; align-items: center; gap: 8px;">
            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" style="color: var(--accent-blue);">
              <path d="M8 0L9.8 6.2L16 8L9.8 9.8L8 16L6.2 9.8L0 8L6.2 6.2L8 0Z" fill="currentColor"/>
            </svg>
            <span class="eyebrow" style="color: var(--accent-blue); font-weight: 700;">WHAT MATTERS TODAY · AI TRADING PARTNER</span>
          </div>
        ...
        <div style="display: flex; justify-content: flex-end; margin-top: 4px;">
          <button id="btn-open-ai-drawer" style="background: var(--accent-blue); color: #101116; border: none; height: 32px; padding: 0 16px; border-radius: 9px; font-size: 0.82rem; font-weight: 700; cursor: pointer; display: flex; align-items: center; gap: 6px; transition: transform var(--dur-fast) ease;">
            Open Full AI Drawer →
          </button>
        </div>
      </div>
