    ...
    <header class="swayam-header">
      ...
      <nav class="nav-pill-row">
        ...
        <button type="button" class="nav-pill ${activePage === 'backtest' ? 'active' : ''}" data-page="backtest" style="opacity: 0.5;" title="Upcoming: BUILD-12">
          Backtest Lab
          <span style="margin-left: 6px; font-size: 0.6rem; padding: 2px 6px; border-radius: var(--radius-pill); background: var(--accent-blue-tint); color: var(--accent-blue); font-weight: 700; letter-spacing: 0.06em;">SOON</span>
        </button>
      </nav>
